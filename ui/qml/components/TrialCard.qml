...
Card {
    ...
    readonly property var live: root.appController ? root.appController.trialLive : ({})

    // Опрос отсчётов идёт, только пока раздел виден и окно открыто: без этого он
    // нагружал бы шину и тогда, когда смотреть на отсчёты некому.
    readonly property bool liveWanted: root.visible && root.Window.visibility !== Window.Hidden && liveSwitch.checked
    onLiveWantedChanged: if (root.appController) root.appController.setTrialLiveEnabled(root.liveWanted)
    Component.onCompleted: if (root.appController) root.appController.setTrialLiveEnabled(root.liveWanted)
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: "Основной контур, сырой период"
                            color: root.textSoft
                            font.pixelSize: 11
                            font.family: "Bahnschrift"
                        }
                        ...
                        Text {
                            text: root.live.mainRaw !== undefined ? root.live.mainRaw : "—"
                        ...
                        Text {
                            text: "итоговый " + (root.live.mainComp !== undefined ? root.live.mainComp : "—")
                            color: root.textSoft
                            font.pixelSize: 11
                            font.family: "Bahnschrift"
                        }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: root.live.media !== undefined ? root.live.media : "—"
