...
class TSMasterDevice():
    ...
    error_code = {1: "Index out of range",
                ...
                152: "Handle pool is full, app_can not add new UDS module",
                ...
                165: "UDS app_can tool is not ready",
                ...
                201: "The Logger device is busy, app_can not operation at the same time",
